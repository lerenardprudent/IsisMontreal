...
//select date(tstamp), sum(value) from your_table group by date(tstamp);
	...
	function fn100($par)		//login
	{
		...
		$querySQL = "select id, fname, lname, alias, type, idusr from " .$userstbl. " where alias='" .$par[1]. "' and pword='" .$par[2]. "'";
		...
		if($result)
		{
			if(mysql_num_rows($result) == 1)
			{
				...
				{
					$retv = "-ok-fn100-" .$row[id]. "¦" .$row[fname]. "¦" .$row[lname]. "¦" .$row[type]. "¦" .$row[idusr];
				}
			}
			else
			{
	...
	function fn102($par)		//load users list (filtered)
	{
		...
		$querySQL = "select id, idusr, idusraux, fname, lname, type, phase, step, status, xgroup, cust2, cust9 from " .$userstbl. " " .$whr. " order by " .$srt. " limit " .$par[1]. ", " . $par[2];
		//echo $querySQL;
		$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		if($result)
		{
			...
			while ($row = mysql_fetch_array($result))
			{
				$retv = $retv. "|" .$row[id]. "¦" .$row[xgroup]. "¦" .$row[fname]. "¦" .$row[lname]. "¦" .$row[idusr]. "¦" .$row[idusraux]. "¦" .$row[type]. "¦" .$row[phase]. "¦" .$row[step]. "¦" .$row[status]. "¦" .$row[cust2]. "¦" .$row[cust9];
			}
		}
		else
		{
	...
	function filteruser($par)
	{
		...
		if ($flt[62] != "---")
		{
			...
			{
				$qfind = "(idusr = '".$flt[62]."' or fname like '%".$flt[62]."%' or lname like '%".$flt[62]."%' or hphone like '%".$flt[62]."%' or cphone like '%".$flt[62]."%' or comments like '%".$flt[62]."%')";
			}
		}
		else
		{
	...
	function fn103($par)		//load user record (based on id)
	{
		...
		if($result)
		{
			...
			while ($row = mysql_fetch_array($result))
			{
				$retv = $retv. $row[id]. "¦" .$row[fname]. "¦" .$row[lname]. "¦" .$row[idusr]. "¦" .$row[idusraux]. "¦" .$row[alias]. "¦" .$row[pword]. "¦" .$row[type]. "¦" .$row[status]. "¦" .$row[lang]. "¦" .$row[birth]. "¦" .$row[sex]. "¦" .$row[matrim]. "¦" .$row[educ]. "¦" .$row[prof]. "¦" .$row[profcode]. "¦" .$row[rev]. "¦" .$row[revcode]. "¦" .$row[hphone]. "¦" .$row[hfax]. "¦" .$row[cphone]. "¦" .$row[haval1]. "¦" .$row[haval2]. "¦" .$row[haval3]. "¦" .$row[hcust1]. "¦" .$row[hcust2]. "¦" .$row[hcust3]. "¦" .$row[hemail]. "¦" .$row[haddress]. "¦" .$row[haddressx]. "¦" .$row[hcity]. "¦" .$row[hstate]. "¦" .$row[hcountry]. "¦" .$row[hpostal]. "¦" .$row[hdate]. "¦" .$row[hlat]. "¦" .$row[hlng]. "¦" .$row[hzone1]. "¦" .$row[hzone2]. "¦"  .$row[hzone3]. "¦" .$row[workplace]. "¦" .$row[wposition]. "¦" .$row[wdate]. "¦" .$row[wphone]. "¦" .$row[wfax]. "¦" .$row[waval1]. "¦" .$row[wcust1]. "¦" .$row[wemail]. "¦" .$row[waddress]. "¦" .$row[waddressx]. "¦" .$row[wcity]. "¦" .$row[wstate]. "¦" .$row[wcountry]. "¦" .$row[wpostal]. "¦" .$row[wlat]. "¦" .$row[wlng]. "¦" .$row[wzone1]. "¦" .$row[wzone2].  "¦" .$row[wzone3]. "¦" .$row[social]. "¦" .$row[xcontact1]. "¦" .$row[xcontact2]. "¦" .$row[xcontact3]. "¦" .$row[cust1]. "¦" .$row[cust2]. "¦" .$row[cust3]. "¦" .$row[cust4]. "¦" .$row[cust5]. "¦" .$row[cust6]. "¦" .$row[cust7]. "¦" .$row[cust8]. "¦" .$row[cust9]. "¦" .$row[checklist]. "¦" .$row[phase]. "¦" .$row[step]. "¦" .$row[xgroup]. "¦" .$row[dateedit]. "¦" .$row[comments];
			}
		}
		else
		{
	...
	function fn104($par)		//save user record (based on id)
	{
		...
		$querySQL = "fname='" .$par[2]. "', lname='" .$par[3]. "', idusr='" .$par[4]. "', idusraux='" .$par[5]. "', alias='" .$par[6]. "', pword='" .$par[7]. "', type='" .$par[8]. "', status='" .$par[9]. "', lang='" .$par[10]. "', birth='" .$par[11]. "', sex='" .$par[12]. "', matrim='" .$par[13]. "', educ='" .$par[14]. "', prof='" .$par[15]. "', profcode='" .$par[16]. "', rev='" .$par[17]. "', revcode='" .$par[18]. "', hphone='" .$par[19]. "', hfax='" .$par[20]. "', cphone='" .$par[21]. "', haval1='" .$par[22]. "', haval2='" .$par[23]. "', haval3='" .$par[24]. "', hcust1='" .$par[25]. "', hcust2='" .$par[26]. "', hcust3='" .$par[27]. "', hemail='" .$par[28]. "', haddress='" .$par[29]. "', haddressx='" .$par[30]. "', hcity='" .$par[31]. "', hstate='" .$par[32]. "', hcountry='" .$par[33]. "', hpostal='" .$par[34]. "', hdate='" .$par[35]. "', hlat='" .$par[36]. "', hlng='" .$par[37]. "', hzone1='" .$z1. "', hzone2='" .$z2. "', hzone3='" .$z3. "', workplace='" .$par[41]. "', wposition='" .$par[42]. "', wdate='" .$par[43]. "', wphone='" .$par[44]. "', wfax='" .$par[45]. "', waval1='" .$par[46]. "', wcust1='" .$par[47]. "', wemail='" .$par[48]. "', waddress='" .$par[49]. "', waddressx='" .$par[50]. "', wcity='" .$par[51]. "', wstate='" .$par[52]. "', wcountry='" .$par[53]. "', wpostal='" .$par[54]. "', wlat='" .$par[55]. "', wlng='" .$par[56]. "', wzone1='" .$z4. "', wzone2='" .$z5. "', wzone3='" .$z6. "', social='" .$par[60]. "', xcontact1='" .$par[61]. "', xcontact2='" .$par[62]. "', xcontact3='" .$par[63]. "', cust1='" .$par[64]. "', cust2='" .$par[65]. "', cust3='" .$par[66]. "', cust4='" .$par[67]. "', cust5='" .$par[68]. "', cust6='" .$par[69]. "', cust7='" .$par[70]. "', cust8='" .$par[71]. "', cust9='" .$par[72]. "', checklist='" .$par[73]. "', phase='" .$par[74]. "', step='" .$par[75]. "', xgroup='" .$par[76]. "', dateedit='" .date("Y-m-d", $td). "', comments='" .$par[78]. "'";
		if ($id == "")			//insert
		{
	...
	function fn150($par)			//users export to csv from filtered list
	{
		...
		if ($par[3] != "") { $whr = filteruser($par[3]); }
		if ($par[4] != "") { $srt = $par[4] . " " . $par[5]; } else { $srt = "id"; }
		$querySQL = "select id, idusr, idusraux, fname, lname, type, phase, step, status, hzone1, hzone2, hzone3, xgroup from " .$userstbl. " " .$whr. " order by " .$srt;
		$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		if($result)
		{
			if ($par[7] == 1)
	...
	function htmusr3($res, $fi, $ti)
	{
		...
		while ($row = mysql_fetch_array($res))
		{
			...
			fwrite($fh, $strdata);
			$strdata = "<tr><td colspan='9'>Contact 2 : " .$row[xcontact3]. "</td></tr>";
			fwrite($fh, $strdata);
		...
		for ($i = 0; $i < $lz; $i++)
		{
			for ($j = 0; $j < $lb; $j++)
			{
				for ($k = 0; $k < $ls; $k++)
				{
					...
					{
						$agl = explode("-", $b[$j]);
						$agl[0] = (2012 - $agl[0]) . "-01-01";
						$agl[1] = (2012 - $agl[1]) . "-01-01";
	...
	function htmusr5($v, $fi)		//planning html
	{
		...
		fwrite($fh, $strdata);
		$strdata = "<br/><table class='maintable'><tr><td class='maintd' style='color:#ff0000'><b>QUART</b></td><td class='maintd' style='color:#ff0000'><b>AGE</b></td><td class='maintd' style='color:#ff0000'><b>SEX</b></td><td class='maintd' style='color:#ff0000'><b>R1</b></td><td class='maintd' style='color:#ff0000'><b>R2</b></td><td class='maintd' style='color:#ff0000'><b>R3</b></td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='6'>LAC</td><td class='maintd' style='color:#ff0000' rowspan='2'>18-30</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[0]. "</td><td class='maintd'>" .$rvals[1]. "</td><td class='maintd'>" .$rvals[2]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[3]. "</td><td class='maintd'>" .$rvals[4]. "</td><td class='maintd'>" .$rvals[5]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='2'>31-45</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[6]. "</td><td class='maintd'>" .$rvals[7]. "</td><td class='maintd'>" .$rvals[8]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[9]. "</td><td class='maintd'>" .$rvals[10]. "</td><td class='maintd'>" .$rvals[11]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='2'>45+</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[12]. "</td><td class='maintd'>" .$rvals[13]. "</td><td class='maintd'>" .$rvals[14]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[15]. "</td><td class='maintd'>" .$rvals[16]. "</td><td class='maintd'>" .$rvals[17]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='6'>LAS</td><td class='maintd' style='color:#ff0000' rowspan='2'>18-30</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[18]. "</td><td class='maintd'>" .$rvals[19]. "</td><td class='maintd'>" .$rvals[20]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[21]. "</td><td class='maintd'>" .$rvals[22]. "</td><td class='maintd'>" .$rvals[23]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='2'>31-45</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[24]. "</td><td class='maintd'>" .$rvals[25]. "</td><td class='maintd'>" .$rvals[26]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[27]. "</td><td class='maintd'>" .$rvals[28]. "</td><td class='maintd'>" .$rvals[29]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='2'>45+</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[30]. "</td><td class='maintd'>" .$rvals[31]. "</td><td class='maintd'>" .$rvals[32]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[33]. "</td><td class='maintd'>" .$rvals[34]. "</td><td class='maintd'>" .$rvals[35]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='6'>PSC</td><td class='maintd' style='color:#ff0000' rowspan='2'>18-30</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[36]. "</td><td class='maintd'>" .$rvals[37]. "</td><td class='maintd'>" .$rvals[38]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[39]. "</td><td class='maintd'>" .$rvals[40]. "</td><td class='maintd'>" .$rvals[41]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='2'>31-45</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[42]. "</td><td class='maintd'>" .$rvals[43]. "</td><td class='maintd'>" .$rvals[44]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[45]. "</td><td class='maintd'>" .$rvals[46]. "</td><td class='maintd'>" .$rvals[47]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='2'>45+</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[48]. "</td><td class='maintd'>" .$rvals[49]. "</td><td class='maintd'>" .$rvals[50]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[51]. "</td><td class='maintd'>" .$rvals[52]. "</td><td class='maintd'>" .$rvals[53]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='6'>VER</td><td class='maintd' style='color:#ff0000' rowspan='2'>18-30</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[54]. "</td><td class='maintd'>" .$rvals[55]. "</td><td class='maintd'>" .$rvals[56]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[57]. "</td><td class='maintd'>" .$rvals[58]. "</td><td class='maintd'>" .$rvals[59]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='2'>31-45</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[60]. "</td><td class='maintd'>" .$rvals[61]. "</td><td class='maintd'>" .$rvals[62]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[63]. "</td><td class='maintd'>" .$rvals[64]. "</td><td class='maintd'>" .$rvals[65]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000' rowspan='2'>45+</td><td class='maintd' style='color:#ff0000'>H</td><td class='maintd'>" .$rvals[66]. "</td><td class='maintd'>" .$rvals[67]. "</td><td class='maintd'>" .$rvals[68]. "</td></tr>";
		fwrite($fh, $strdata);
		$strdata = "<tr><td class='maintd' style='color:#ff0000'>F</td><td class='maintd'>" .$rvals[69]. "</td><td class='maintd'>" .$rvals[70]. "</td><td class='maintd'>" .$rvals[71]. "</td></tr>";
		fwrite($fh, $strdata);
	...
	{
		$fh = fopen($fi, 'w');	 //or die("can't open file");
		$strdata = "<html><head><title>Liste des activitées</title><meta http-equiv='Content-Type' content='text/html; charset=utf-8'><style>@media all{.page-break { display:none; }} @media print{ .page-break { display:block; page-break-before:always; }} table{ width:100%; border-style:solid; border-width:1px; border-color:#ff0000; font-family:arial,sans-serif; font-size:12px; color:#606060; border-spacing:0px; border-collapse:collapse; }  td{ border-style:solid; border-width:0px 0px 1px 0px; border-color:#ff0000; padding:1px 8px 1px 8px; } .red {color:#ff0000; } .title{ font-weight:bold; padding:0px 0px 4px 6px; margin:0px}</style></head> <body style='margin:8px; font-family:arial,sans-serif; font-size:16px; color:#606060;'> <div class='title'>" .$ti. "</div>";
		fwrite($fh, $strdata);
		$i = 0;
		while ($row = mysql_fetch_array($res))
		{
	...
	function htmact2($res, $fi, $ti)
	{
		...
		while ($row = mysql_fetch_array($res))
		{
			if ($idu != $row[idusr])
			{
				if ($i != 0)
				{
					$strdata = "<tr><td colspan='6' align='right'><b>Total</b></td><td align='right'><b>" . $tota. "</b></td><td align='right'><b>$ " . number_format($totb,2) . "</b></td><td></td></tr>";		//total here
					fwrite($fh, $strdata);
					$tota = 0;
					$totb = 0;
					$strdata = "</table><div class='red'><br/>Signature du superviseur:________________________________</div></div><div class='page-break'></div>";
					fwrite($fh, $strdata);
				}
				$i += 1;
				...
				$strdata = "<br/><table><tr><td class='red'>#</td><td class='red'>ID Resp.</td><td class='red'>Nom&nbsp;responsable</td><td class='red'>ID&nbsp;Parti.</td><td class='red'>Temps</td><td class='red'>Date&nbsp;activ.</td><td class='red' align='right'>Km.</td><td class='red' align='right'>Coût Km.</td><td class='red'>Payé&nbsp;le</td></tr>";
				fwrite($fh, $strdata);
			}
			$strdata = "<tr><td>" .$row[id]. "</td><td><b>" .$row[idusr]. "</b></td><td><b>" .$row[nameusr]. "</b></td><td>" .$row[idparti]. "</td><td>" .$row[pphase]. "</td><td>" .$row[dend]. "</td><td align='right'><b>" .$row[cust0]. "</b></td><td align='right'><b>$ " .number_format($row[cust1],2). "</b></td><td>" .$row[cust2]. "</td></tr>";
			fwrite($fh, $strdata);
			$idu = $row[idusr];
			$tota += $row[cust0];
			$totb += $row[cust1];
		...
		$strdata = "<tr><td colspan='6' align='right'><b>Total</b></td><td align='right'><b>" . $tota. "</b></td><td align='right'><b>$ " . number_format($totb,2) . "</b></td><td></td></tr>";		//total here
		fwrite($fh, $strdata);
		$strdata = "</table><div class='red'><br/>Signature du superviseur:________________________________</div>";
		fwrite($fh, $strdata);
		//if ($i != 0) { $strdata = "</table></body></html>"; } else { $strdata = "</body></html>"; }
		$strdata = "</body></html>";
		fwrite($fh, $strdata);
	...
	function htmact3($res, $fi, $ti)
	{
		...
		while ($row = mysql_fetch_array($res))
		{
			if ($idu != $row[idusr])
			{
				if ($i != 0)
				{
					$strdata = "<tr><td colspan='6' align='right'><b>Total</b></td><td align='right'><b>" . number_format($tota,2) . "</b></td><td align='right'><b>$ " . number_format($totb,2) . "</b></td><td></td></tr>";		//total here
					fwrite($fh, $strdata);
					$tota = 0;
					$totb = 0;
					$strdata = "</table><div class='red'><br/>Signature du superviseur:________________________________</div><div class='page-break'></div>";
					fwrite($fh, $strdata);
				}
				$i += 1;
				$strdata = "<div class='title'> " .$ti. "</div>";
				fwrite($fh, $strdata);
				$strdata = "<br/><table><tr><td class='red'>#</td><td class='red'>ID Resp.</td><td class='red'>Nom&nbsp;responsable</td><td class='red'>ID&nbsp;Parti.</td><td class='red'>Temps</td><td class='red'>Date&nbsp;activ.</td><td class='red' align='right'>Temps</td><td class='red' align='right'>Coût temps</td><td class='red'>Payé&nbsp;le</td></tr>";
				fwrite($fh, $strdata);
			}
			$strdata = "<tr><td>" .$row[id]. "</td><td><b>" .$row[idusr]. "</b></td><td><b>" .$row[nameusr]. "</b></td><td>" .$row[idparti]. "</td><td>" .$row[pphase]. "</td><td>" .$row[dend]. "</td><td align='right'><b>" .number_format($row[cust3],2). "</b></td><td align='right'><b>$ " .number_format($row[cust4],2). "</b></td><td>" .$row[cust5]. "</td></tr>";
			fwrite($fh, $strdata);
			$idu = $row[idusr];
			$tota += $row[cust3];
			$totb += $row[cust4];
	...
	function fn401($par)			//save answers on closing questionnaire
	{
		global $userstbl;
		$retv = "-er-sql-";
		...
		if ($trows == 0)
		{
			$querySQL = "insert into answer set id='NULL', idq='" .$par[1]. "', idu='" .$par[2]. "', idusr='" .$par[3]. "', answ='" .$par[4]. "', answmap='" .$par[6]. "', nav='" .$par[5]. "', dateedit='" .date("Y-m-d", $td). "'";
		}
		else
		{
			$querySQL = "update answer set idusr='" .$par[3]. "', answ='" .$par[4]. "', answmap='" .$par[6]. "', nav = concat(nav,'" .$par[5]. "'), dateedit='" .date("Y-m-d", $td). "' where idq='" .$par[1]. "' and idu='" .$par[2]. "'";
		}
		$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		if($result)
		{
			$lpg = explode("-", $par[5]);
			for ($i = count($lpg) - 1; $i >= 0; $i -= 1)
			{
				$lpg[$i] = explode(":", $lpg[$i]);
				if (is_numeric($lpg[$i][0]))
				{
					$querySQLx = "update users set cust3='" .$lpg[$i][0]. "' where  id='" .$par[2]. "'";							//save returnpage (cust1) in user
					$resultx = @mysql_query($querySQLx);		// or die ("-er-sql-" . mysql_error());
					break;
				}
			}
	...
	function fn402($par)			//load answers questionnaire
	{
		...
		$querySQL = "select answ, answmap, nav from answer where idq ='" .$par[1]. "' and idu ='" .$par[2]. "'"; 
		$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		if($result)
		{
			$retv = "-ok-fn402-";
			while ($row = mysql_fetch_array($result))
			{
				$retv = $retv. $row[answ]. "¦" .$row[nav]. "¦" .$row[answmap];
			}
		}
		else
		{
	...
	*/
	...
	function fn500($par)			//make activities from questionnaire
	{
		$retv = "-ok-fn500-";		
		return $retv;
	}
	...
	function fn600($par)		//save user data from questionnaire
	{
		//global $userstbl;
		...
		//================================   update participant step and status (phase) from questionnaire:
		
		if ($act == "QUIT")
		{
			$querySQL = " type = 'PAR', phase = 'BEANZ1', step = 'QUE', status = 'INT', cust9 = '" . descetasta("QUE","INT") . "', cust2 = '".date("Y-m-d", $td)."'";
			$querySQL = "update users set " . $querySQL . " where id='" .$par[2]. "'";
			$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		}
		else if ($act == "ABAN" || $act == "ABA1" || $act == "ABA2" || $act == "ABA3")
		{
			$querySQL = " type = 'PAR', phase = 'BEANZ1', step = 'QUE', status = 'ABA', cust9 = '" . descetasta("QUE","ABA") . "', cust2 = '".date("Y-m-d", $td)."'";
			$querySQL = "update users set " . $querySQL . " where id='" .$par[2]. "'";
			$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		}
		else if ($act == "RABA" || $act == "NEXT")
		{
			$querySQL = " type = 'PAR', phase = 'BEANZ1', step = 'QUE', status = 'UWA', cust9 = '" . descetasta("QUE","UWA") . "', cust2 = '".date("Y-m-d", $td)."'";
			$querySQL = "update users set " . $querySQL . " where id='" .$par[2]. "'";
			$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		}
		else if ($act == "FCOM")
		{
			$querySQL = " type = 'PAR', phase = 'BEANZ1', step = 'QUE', status = 'COM', cust9 = '" . descetasta("QUE","COM") . "', cust2 = '".date("Y-m-d", $td)."'";
			$querySQL = "update users set " . $querySQL . " where id='" .$par[2]. "'";
			$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		}
		else if ($act == "FABA")
		...
		{
			$querySQL = " type = 'PAR', phase = 'BEANZ1', step = 'QUE', status = 'CAN', cust9 = '" . descetasta("QUE","CAN") . "', cust2 = '".date("Y-m-d", $td)."'";
			$querySQL = "update users set " . $querySQL . " where id='" .$par[2]. "'";
			$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		}
		...
		//================================   fill in paticipant data to participant record from the questionnaire:
		
		/*
		if ($par[4] == 28)			//layout #: start end acquisition
		{
			$ppa = explode("·", $par[5]);
			$pv1 = $ppa[2];
			$pv2 = $ppa[3];
			$querySQL = "cust6='" .$pv1. "', cust7='" .$pv2. "'";
			$querySQL = "update users set " . $querySQL . " where id='" .$par[2]. "'";
			$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		}
		else if ($par[4] == 29)			//layout #: availability
		{
			$ppa = explode("·", $par[5]);
			if ($ppa[11] == "1") { $pr = "SMSR"; } else { $pr = "NR"; }
			$pv1 = $ppa[2] . " - " . $ppa[3] . " - " . $ppa[4] . " - " . $ppa[7] . " - " . $ppa[10] . " - " . $pr;
			$pv2 = $ppa[18];
			$pv3 = $ppa[25];
			$pv4 = $ppa[31];
			
			//$querySQL = "haval1='" .$pv1. "', haval2='" .$pv2. "', haval3='" .$pv3. "', hphone='" .$pv5. "', hfax='" .$pv6. "', cphone='" .$par[21]. "', social='" .$pv4. "'
			$querySQL = "haval3='" .$pv1. "', hfax='" .$pv3. "', cphone='" .$pv4. "', social='" .$pv2. "'";
			$querySQL = "update users set " . $querySQL . " where id='" .$par[2]. "'";
			$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		}
		else if ($par[4] == 30)			//layout #: colissimo
		{
			$ppa = explode("·", $par[5]);
			$pv1 = $ppa[0];			
			$querySQL = "cust4='" .$pv1. "'";
		...
		else if ($par[4] == 31)			//layout #: call end of study
		{
			$ppa = explode("·", $par[5]);
			$pv1 = "";
			for ($i = 0; $i < 20; $i += 5)			//loop 4 times
			{
				$pv1 .= $ppa[$i]." ".$ppa[$i + 1]."-".$ppa[$i + 2]." ".$ppa[$i + 3]."-".$ppa[$i + 4]." ";
			}
			$pv1 = trim($pv1);
			$querySQL = "haval2='" .$pv1. "'";
			$querySQL = "update users set " . $querySQL . " where id='" .$par[2]. "'";
		...
		else if ($par[4] == 33)			//layout #: mail in adress
		{
			$ppa = explode("·", $par[5]);
			$pv1 = $ppa[4];
			$pv2 = $ppa[5];
			...
			$querySQLx = "select id from addressmail where idu = '" .$par[2]. "'";
			$resultx = @mysql_query($querySQLx);		// or die ("-er-sql-" . mysql_error());
			if ($resultx) { $trows = mysql_num_rows($resultx); }
			if ($trows == 1)
			{
				$querySQL = "update addressmail set address='" .$pv1. "', addressx='" .$pv2. "', postal='" .$pv3. "', city='" .$pv4. "' where idu = '" .$par[2]. "'";
			}
			else
			{
				$querySQL = "insert into addressmail set id='NULL', idu='" .$par[2]. "', address='" .$pv1. "', addressx='" .$pv2. "', postal='" .$pv3. "', city='" .$pv4. "'";	
			}
			$result = @mysql_query($querySQL);		// or die ("-er-sql-" . mysql_error());
		...
		*/
		...
		//================================   create participants activities (tasks + events) from the questionnaire:
		
		/*
		if ($act == "FCOM")		//($par[4] == 36)
		{

			$querySQL = "select id, idusr, fname, lname from users where id = '" .$par[1]. "'";				//responsible
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());
			while ($row = mysql_fetch_array($result))
			{
				$u1 = $row[id];
				$u2 = $row[idusr];
				$u3 = $row[fname] . " " . $row[lname];
			}
			
			$querySQL = "select id, idusr, fname, lname, xgroup, cust6, cust7 from users where id = '" .$par[2]. "'";		//participant
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());
			while ($row = mysql_fetch_array($result))
			{
				$p1 = $row[id];
				$p2 = $row[idusr];
				$p3 = $row[fname] . " " . $row[lname];
				$p4 = $row[xgroup];
				$p5 = $row[cust6];
				$p6 = $row[cust7];
			}
			...
			$querySQL = "insert into activity set id='NULL', idu = '" .$u1. "', idp = '" .$p1. "', idusr = '" .$u2. "', idparti = '" .$p2. "', nameusr = '" .$u3. "', nameparti = '" .$p3. "', activity = 'TAC', status = 'PLA', mode = 'SYS', code = 'ASS', ptype = 'PAR', pphase = 'BEANZ1', pstep = 'ACQ', pstatus = 'UWA', description = '" .descactcod("PLA","ASS"). "', cust0 = '1', cust1 = '1', cust8 = '" .descetasta("ACQ","UWA"). "', pxgroup = '" .$p4. "', dstart = '" .date("Y-m-d", $td). "', dend = '" .date("Y-m-d", $td). "'";
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());		//assign device

			$querySQL = "insert into activity set id='NULL', idu = '" .$u1. "', idp = '" .$p1. "', idusr = '" .$u2. "', idparti = '" .$p2. "', nameusr = '" .$u3. "', nameparti = '" .$p3. "', activity = 'TAC', status = 'PLA', mode = 'SYS', code = 'GEN', ptype = 'PAR', pphase = 'BEANZ1', pstep = 'ACQ', pstatus = 'INI', description = '" .descactcod("PLA","GEN"). "', cust0 = '1', cust1 = '2', cust8 = '" .descetasta("ACQ","INI"). "', pxgroup = '" .$p4. "', dstart = '" .$p5. "', dend = '" .$p6. "'";
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());		//init acquisition

			
			$querySQL = "insert into activity set id='NULL', idu = '" .$u1. "', idp = '" .$p1. "', idusr = '" .$u2. "', idparti = '" .$p2. "', nameusr = '" .$u3. "', nameparti = '" .$p3. "', activity = 'TAC', status = 'PLA', mode = 'SYS', code = 'TEL', ptype = 'PAR', pphase = 'BEANZ1', pstep = 'ACQ', pstatus = 'UWA', description = '" .descactcod("PLA","TEL"). "', cust0 = '1', cust1 = '3', cust8 = '" .descetasta("ACQ","UWA"). "', pxgroup = '" .$p4. "', dstart = '" .date("Y-m-d", $tw). "', dend = '" .date("Y-m-d", $tw). "', comments = 'Premier appel en acquisiton.'";
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());		//first phone call

			
			$querySQL = "insert into activity set id='NULL', idu = '" .$u1. "', idp = '" .$p1. "', idusr = '" .$u2. "', idparti = '" .$p2. "', nameusr = '" .$u3. "', nameparti = '" .$p3. "', activity = 'EVT', status = 'FIN', mode = 'SYS', code = 'GEN', ptype = 'PAR', pphase = 'BEANZ1', pstep = 'ACQ', pstatus = 'ABA', description = '" .descactcod("FIN","GEN"). "', cust0 = '1', cust1 = '4', cust8 = '" .descetasta("ACQ","ABA"). "', pxgroup = '" .$p4. "', dstart = '" .date("Y-m-d", $td). "', dend = '" .date("Y-m-d", $tw). "', comments = 'Premier abandon en acquisiton.'";
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());		//(first) abandon in ACQ + sales pitch

			
			$querySQL = "insert into activity set id='NULL', idu = '" .$u1. "', idp = '" .$p1. "', idusr = '" .$u2. "', idparti = '" .$p2. "', nameusr = '" .$u3. "', nameparti = '" .$p3. "', activity = 'EVT', status = 'FIN', mode = 'SYS', code = 'GEN', ptype = 'PAR', pphase = 'BEANZ1', pstep = 'ACQ', pstatus = 'ABA', description = '" .descactcod("FIN","GEN"). "', cust0 = '1', cust1 = '5', cust8 = '" .descetasta("ACQ","ABA"). "', pxgroup = '" .$p4. "', dstart = '" .date("Y-m-d", $td). "', dend = '" .date("Y-m-d", $tw). "', comments = 'Abandon final en acquisiton.'";
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());		//(second) abandon in ACQ - sales pitch

			
			$querySQL = "insert into activity set id='NULL', idu = '" .$u1. "', idp = '" .$p1. "', idusr = '" .$u2. "', idparti = '" .$p2. "', nameusr = '" .$u3. "', nameparti = '" .$p3. "', activity = 'EVT', status = 'FIN', mode = 'SYS', code = 'APV', ptype = 'PAR', pphase = 'BEANZ1', pstep = 'ACQ', pstatus = 'APV', description = '" .descactcod("FIN","APV"). "', cust0 = '1', cust1 = '6', cust8 = '" .descetasta("ACQ","APV"). "', pxgroup = '" .$p4. "', dstart = '" .date("Y-m-d", $td). "', dend = '" .date("Y-m-d", $td). "', comments = 'Dèclaré perdu.'";
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());		//device problems
			
			
			$querySQL = "insert into activity set id='NULL', idu = '" .$u1. "', idp = '" .$p1. "', idusr = '" .$u2. "', idparti = '" .$p2. "', nameusr = '" .$u3. "', nameparti = '" .$p3. "', activity = 'TAC', status = 'PLA', mode = 'SYS', code = 'TEL', ptype = 'PAR', pphase = 'BEANZ1', pstep = 'ACQ', pstatus = 'UWA', description = '" .descactcod("PLA","TEL"). "', cust0 = '1', cust1 = '7', cust8 = '" .descetasta("ACQ","UWA"). "', pxgroup = '" .$p4. "', dstart = '" .$p6. "', dend = '" .$p6. "', comments = 'Dernier appel en acquisiton.'";
			$result = @mysql_query($querySQL) or die ("-er-sql-" . mysql_error());		//first phone call
	...
	function descetasta($d1, $d2)
	{
		...
		$de = "";
		for ($i = 0; $i < count($abbreta); $i++)
		{
			if ($abbreta[$i][0] == $d1) { $de = $abbreta[$i][1]; break; } 
		}
		for ($i = 0; $i < count($abbrsta); $i++)
		{
			if ($abbrsta[$i][0] == $d2) { $de .=  " - ".strtolower($abbrsta[$i][1]); break; } 
		}
		return $de;
	}
	
	function descactcod($d1, $d2)
	{
		...
		$de = "";
		for ($i = 0; $i < count($abbract); $i++)
		{
			if ($abbract[$i][0] == $d1) { $de = $abbract[$i][1]; break; } 
		}
		for ($i = 0; $i < count($abbrcod); $i++)
		{
			if ($abbrcod[$i][0] == $d2) { $de .=  " - ".strtolower($abbrcod[$i][1]); break; } 
		}
		return $de;
	}
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	$abbreta = array(array("---",""),array("INI","Initiale"),array("QUE","Questionnaire"),array("ACQ","Acquisition"),array("TRD","Data transfer"),array("V3E","V3E"),array("FIN","Final"));
	$abbrsta = array(array("---", ""), array("INI", "Initial"), array("UWA", "Under way"), array("INT", "Interruption"), array("ABA", "Abandon"), array("COM", "Completed"), array("CAN", "Canceled"));
	$abbract = array(array("---",""),array("PLA", "Planifié"), array("UWA", "En cours"), array("ANN", "Annulé"), array("FIN", "Finalisé"));
	$abbrcod = array(array("---", ""), array("GEN", "Générique"), array("INV", "Appareil en inventaire"), array("ASS", "Appareil assigné"), array("ALI", "Appareil livré"), array("AHS", "Appareil hors-service"), array("APV", "Appareil perdu / volé"), array("AMR", "Appareil mis au rebut"), array("SPA", "Suivi problème appareil"), array("DOR", "Données récupérées"), array("DOT", "Données transmises"), array("SCO", "Suivi courrier"), array("TEL", "Appel téléphonique"), array("FAX", "Message fax"), array("EMA", "Message courriel (e-mail)"), array("SMS", "Message SMS"), array("POS", "Lettre par la poste"));
	$abbrass = array(array("---", ""), array("INV", "Inventaire"), array("APA", "Appareil assigné"), array("ALI", "Appareil livré"), array("AHS", "Appareil hors-service"), array("APV", "Appareil perdu / volé"), array("AMR", "Appareil mis au rebut"));
	...
	if($pvarx != "")
	{
		...
		$database = "beanztre_beanz";
		$username="beanztre_trksft";
		$password = "tr3ks0ft";
		...
		elseif ($pvarx[0] == "fn303")			//load assets record
		{
			$retvar = fn303($pvarx);
		}
		elseif ($pvarx[0] == "fn304")			//insert / update assets record
		{
			$retvar = fn304($pvarx);
		}
		elseif ($pvarx[0] == "fn305")			//delete assets record
		{
			$retvar = fn305($pvarx);
		}
		...
		//{
			//$retvar = fn403($pvarx);
		//}
		elseif ($pvarx[0] == "fn500")			//make activity from questionnaire, update in smapp
		{
			$retvar = fn500($pvarx);
		}
		elseif ($pvarx[0] == "fn600")			//save questionnaire answers update user in smapp
		{
			$retvar = fn600($pvarx);
		}
